  ...
  transform: rotate(10deg);
    ...
    <body style="font-family: Century; font-size: 18px;">
     ...
     <div class="container-fluid">
         ...
         <section class="my-5">
            <div class="py-5">
                <h1 class="text-center">Bridal Offer!! </h1>  
...
and skin care services will suit every beauty need.</p>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row" aboutim>
                      <img src="images/priceji.png" class="img-fluid" style="margin-left: 14%;" >
            ...
            <section class="my-5">
            <div class="py-5">
                <h1 class="text-center">Bridal Services <img src="images/brush.jpg" style="width:55px; width:55px;"></h1>   
                <div  class="text-center">________________</div>
                <p class="text-center">Treat yourself to a facial or celebrating a special occasion, aromatherapy, our beauty<br> 
and skin care services will suit every beauty need.</p>
            </div>
            <div class="container-fluid">
                ...
                <div class="agileinfo-top-grids">
                    <img class="card-img-top" src="images/bridal2.png" alt="Card image">
  <div class="card-body">
      <h4 class="card-title"><strong>Bridal makeup</strong></h4>
    <p class="card-text">Get 30%off on Bridal makeup is a lavish affair get it done from the best.your hand blush when you let stay longer mehendi in your hand. </p>
    <a href="booking.jsp" class="btn btn-black">Book now</a>
  </div>
  </div>
  </div>
                 <div class="col-lg-4 col-md-4 col-12">
                <div class="agileinfo-top-grids">
                    <img class="card-img-top" src="images/mehendi2.png" alt="Card image">
  <div class="card-body">
      <h4 class="card-title"><strong>Hand Mehendi design</strong></h4>
    <p class="card-text">Best mehendi design arabic and full hand for bridal  Special 10% off for bridal. </p><br>
    <a href="booking.jsp" class="btn btn-black">Book now</a>
  </div>
  </div>
  </div>
                <div class="col-lg-4 col-md-4 col-12">
                <div class="agileinfo-top-grids">
                    <img class="card-img-top" src="images/foot2.png" alt="Card image">
  <div class="card-body">
      <h4 class="card-title"><strong>Foot Mehendi design</strong></h4>
    <p class="card-text">Adorable foot deisgn Special 10%off for bridal..mehendi adorns the hands and life takes on a new color. </p>
    <br>
    <a href="booking.jsp" class="btn btn-black">Book now</a>
  </div>
  </div>
