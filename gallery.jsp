...
.fa-facebook {
  ...
  transform: rotate(10deg);
    ...
    <body style="font-family: Century;font-size: 18px;">
     ...
     <section class="my-5">
            <div class="py-5">
                <h1 class="text-center">Our Gallery <img src="images/galli.png" style="width:55px; width:55px;"></h1>   
            ...
            <div class="container-fluid">
                <div class="row no-gutters">
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p1.jpg"><img src="images/p1.jpg" class="img-fluid pb-3"></a>

                    </div>
                
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p2.jpg"><img src="images/p2.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p3.jpg"><img src="images/p3.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p4.jpg"><img src="images/p4.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p5.jpg"><img src="images/p5.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p6.jpg"><img src="images/p6.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p7.jpg"><img src="images/p7.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p8.jpg"><img src="images/p8.jpg" class="img-fluid pb-3"></a>

                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p9.jpg"><img src="images/p9.jpg" class="img-fluid pb-3"></a>

                    </div>
                       <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p10.jpg"><img src="images/p10.jpg" class="img-fluid pb-3"></a>

                    </div>
                       <div class="col-lg-4 col-md-4 col-12">
                        <a href="images/p11.jpg"><img src="images/p11.jpg" class="img-fluid pb-3"></a>

                    </div>
                      <div class="col-lg-4 col-md-4 col-12">
                          <a href="images/p12.jpg"><img src="images/p12.jpg" class="img-fluid pb-3"></a>
...
$(document).ready(function() {
 ...
 /*Scroll to top when arrow up clicked END*/
    ...
    <!--footer end-->
         <a href="gallery.jsp" class="scroll" id="toTop" style="display: block;"> <span id="toTopHover" style="opacity: 1;"> </span></a>
          <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
         <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
         <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    </body>
