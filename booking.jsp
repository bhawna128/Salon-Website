  ...
  transform: rotate(10deg);
    ...
    <body style="font-family: Century; font-size: 18px;">
     ...
     <div class="container-fluid">
         ...
         <section class="my-5">
            <div class="py-5">
                <h1 class="text-center">Online Booking <img src="images/phone.png" style="width:55px; width:55px; margin-top: 0%;"></h1>  
...
and skin care services will suit every beauty need.</p>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row" aboutim>
                      <img src="images/ct.jpg" class="img-fluid" style="margin-left: 10px;" >
              <div class="w-50 m-auto">
                  <form action="appoinment.jsp" method="post">
                     <div class="form-inline">
                         <label><strong>Username</strong></label>
                         <input type="text" name="user" autocomplete="off" class="form-control" required="" placeholder="Your Name" style="margin-left: 10px;">
                         <span style="margin-left:30px;"><strong>Date</strong></span><input type="date" name="date" autocomplete="off" class="form-control" required="" placeholder="Your Name" style="margin-left: 10px;">
                     </div>
                      <br>
                      <div class="form-inline">
                          <label><strong>Email Id</strong></label>
                         <input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="email" autocomplete="off" class="form-control" required="" placeholder="Your Email Id" style="margin-left: 24px;">
                         <span style="margin-left:30px;"><strong>Time</strong></span><input type="time" name="time" autocomplete="off" class="form-control" required="" placeholder="Your Name" style="margin-left: 10px;">
                      </div>
                      <br>
                      <div class="form-inline">
                          <label><strong>Mobile</strong></label>
                         <input type="text" name="mobile" autocomplete="off" class="form-control" required="" placeholder="Your Mobile "style="margin-left: 41px;">
                         <span style="margin-left:20px;"><strong>Location</strong></span><input type="text" name="location" autocomplete="off" class="form-control" required="" placeholder="Type your location" style="margin-left: 10px;">
                     </div>
                      <br>
                      <div class="form-inline">
                          <label><strong>Comments</strong></label>
                         <textarea  class=form-control required="" name="comments"style="margin-left: 10px;"></textarea>
                         <span style="margin-left:28px;"><strong>Service</strong></span><input type="text" name="service" autocomplete="off" class="form-control" required="" placeholder="Your services" style="margin-left: 10px;">
                     </div>
                      <br>
                      <span style="margin-left: 18%;"></span><button type="submit" class="btn btn-black" >Book now</button>
